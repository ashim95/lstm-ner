...
def get_features_from_java_program(list_of_sentences, config):
    ...
    command = "java -Xmx32g -cp " + config.java_jar_file + ":drugner_java/lib/*:drugner_java/models/dnormdata/libs/*" 
    command = command + " utils.FeatureExtractor 'logs/input/in.txt' 'logs/output/out.txt' 'drugner_java/' 'data/drug_names_wiki.txt' 'data/drug_names_69629_names.txt' "
